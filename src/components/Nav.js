        ...
        <header>
            ...
            <nav id="nav-bg" className="navbar fixed-top navbar-expand-lg navbar-light bg-light">
                ...
                <div className="navbar-nav ml-auto">
                    ...
                    <a className="nav-item nav-link" href="https://github.com/joydotcom" target="_blank" rel="noreferrer">GitHub</a>
                    <a className="nav-item nav-link" href="https://www.linkedin.com/in/joysjackson" target="_blank" rel="noreferrer">LinkedIn</a>
                </div>
            </nav>
            </div>
        </header>
